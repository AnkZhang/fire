...
var pagerFilter=function (data) {
    ...
    for (var i=0;i<temp.length;i++){
        ...
        if(temp[i].meterKind=="E"){
            data.rows[i].meterKind="电表"
        }else if (temp[i].meterKind=="F"){
            data.rows[i].meterKind="流量表"
        }else if (temp[i].meterKind=="G"){
            data.rows[i].meterKind="天然气表"
        }else if (temp[i].meterKind=="T"){
            data.rows[i].meterKind="温度表"
        }else if (temp[i].meterKind=="W"){
            data.rows[i].meterKind="水表"
        };
        if (temp[i].meterType=="E-A"){
            data.rows[i].meterType="三相电表"
        }else if(temp[i].meterType=="E-B"){
            data.rows[i].meterType="单相多功能导轨"
        }else if(temp[i].meterType=="E-ZB"){
            data.rows[i].meterType="单相直流多功能"
        }else if(temp[i].meterType=="W-1"){
            data.rows[i].meterType="直读水表"
        }
    }
